...
import app.lawnchair.util.hasLimitedRecentsActions
...
class PreferenceManager private constructor(private val context: Context) :
    ...
    val recentsActionScreenshot = BoolPref("pref_recentsActionScreenshot", !hasLimitedRecentsActions)
    val recentsActionShare = BoolPref("pref_recentsActionShare", hasLimitedRecentsActions)
